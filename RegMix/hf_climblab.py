...
#    standardize = average_file_size/ ordered_avg_cluster_file_sizes[cluster]
    ...
    cluster_distribution[cluster] = max(int(1000 * (random.randint(0, 30)/10 * predicted_dist[cluster]) + random.randint(-500, 500)),0) #*standardize    #randomly assign distribution size
