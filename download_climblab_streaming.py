...
# IMPORTANT: Hardcoding tokens directly into the code is a security risk.
# It is strongly recommended to use environment variables or `huggingface-cli login` instead.
TOKEN = "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"
...
with open("../Filtering-Techniques/preselect_training/climblab_first_million.jsonl", "w") as f:
